...
export type EmitFunction = (tenant: string, message: GenericMessage, indexes: KeyValues, ...additionalIndexes: KeyValues[]) => void;
...
export interface EventStream {
  ...
  emit(tenant: string, message: GenericMessage, indexes: KeyValues, ...additionalIndexes: KeyValues[]):void;
  open(): Promise<void>;
  close(): Promise<void>;
}
